...
If port geometry information is available, as created by the latest version of gds2palace, an additionial file with de-embedded results is creates. This is an experiemental feature, it cascades negative series L at each port based on thin ribbon inductance calculation from port width and length.
