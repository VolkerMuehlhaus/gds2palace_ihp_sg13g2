...
settings['unit'] = 1e-06
settings['purpose'] = [0]
settings['GdsFile'] = 'D:/github-claude/gds2palace_ihp_sg13g2/test_data/filled_metal_L2n0/L_2n0_twoport.gds'
settings['SubstrateFile'] = 'D:/github-claude/gds2palace_ihp_sg13g2/test_data/filled_metal_L2n0/SG13G2_200um.xml'
settings['preprocess_gds'] = True
settings['merge_polygon_size'] = 2.0
settings['margin'] = 150.0
